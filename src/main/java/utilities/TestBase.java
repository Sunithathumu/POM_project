...
import src.main.java.com.sfdc.listeners.ExtentManager;
...
public class TestBase {
    ...
    public static src.main.java.utilities.Constants oCons = new src.main.java.utilities.Constants();
	...
	*/
        ...
        if (System.getProperty("AutomationRunning").equalsIgnoreCase(src.main.java.utilities.Constants.sAutomationAPI)) {
        ...
        if (System.getProperty("AutomationRunning").equalsIgnoreCase(src.main.java.utilities.Constants.sAutomationWeb.toLowerCase())) {
